...
EZRA_4_12 = [
    ...
    *_intro_and_img(_BKM_REC_SND_SAM_5_2),
    ...
    my_html.table(
        [
            my_html.table_row_of_data(['WLC', 'הָיִ֛יתָ', 'הַמּוֹצִ֥יא', 'וְהַמֵּבִ֖יא'], _ONE_NONE_3_BIG),
            my_html.table_row_of_data(['ל', 'הָיִ֛יתָה', 'הַמּוֹצִ֥יא', 'וְהַמֵּבִ֖יא'], _ONE_NONE_3_BIG),
            my_html.table_row_of_data(['א', 'הָיִ֛יתָ', 'הַמּוֹצִ֥יא', 'וְהַמֵּבִ֖י'], _ONE_NONE_3_BIG),
        ],
        {'dir': 'rtl'}
    ),
    my_html.para([
