...
RECORDS = [
    ...
    'remarks': ["Side note: Dotan notes a later instance of this word in this verse, וְיִשְׁתַּחֲוּ֥וּ. "+
    ...
    'at issue': "בּ",
    'summary': "+dgsh",
    'remarks': ["The MPK’s מ does not carry a dagesh for the qere’s ב, for some reason. "+
    ...
    "The MPK (points on no letters!) is sheva, tsere, and munaḥ.",
        ...
        "Side note: Dotan notes that the next word unexpectedly starts with בּ not ב, i.e. בִנְיָמִ֔ן would be expected."]},
    {'wlc-index': 7,
    ...
    'at issue': "נְיָ",
    'summary': "+shva—-mqf",
    'remarks': ["The MPK’s final nun of מבן does not carry a sheva for the qere’s (non-final) נ, perhaps because that would be illegal. "+
    ...
    'at issue': "וּ",
    'summary': "qbts to shrq",
    'remarks': ["There’s a large, clear dot above the ר; I don’t know what it is supposed to mean, if anything. "+
    "Surely not a revia!"]},
    {'wlc-index': 13,
    ...
    'remarks': ["The MPK’s ע does not carry a pataḥ for the qere’s ע, perhaps because that would be illegal. "+
    ...
    'at issue': "פּ",
    'summary': "+dgsh",
    'remarks': ["The MPK has no letter to carry a dagesh for the qere’s פ. "+
    ...
    'at issue': "־",
    'summary': "+mqf",
    'remarks': ["The MPK lacks a trailing maqaf. "+
    ...
    "I do not think he finds the MPK’s lack of dagesh notable because as far as I know, such a dagesh is never present."]},
    {'wlc-index': 40,
    ...
    'at issue': "כּ",
    'summary': "+dgsh",
    'remarks': ["The MPK has no letter to carry a dagesh for the qere’s כ. "+
    "The MPK (points on no letters!) is tsere and merkha. "+
    "Well really those points are under ל not under nothing.",
        "Dotan notes that strictly speaking, the implied qere is עַל כֵ֥ן. "+
    "I think what he finds notable here is the MPK’s lack of a maqaf. "+
    ...
    "I would have expected a qubuts in the MPK, but this notation works, too, as long as we interpret the MPK’s dot in the vav to be a shuruq dot not a dagesh."]},
    {'wlc-index': 21,
    ...
    'at issue': "וּ",
    'summary': "qbts to shrq",
    'remarks': ["In WLC, this word also has a c-note, presumably because WLC has qadma where BHS (in error) has pashta."]},
    {'wlc-index': 22,
    ...
    'at issue': "וֹ",
    'summary': "+ḥlm dt",
    'remarks': ["The MPK has no letter to carry a ḥolam dot on the qere’s vav. "+
    ...
    'at issue': "וּ",
    'summary': "qbts to shrq",
    'remarks': ["Side note: The dagesh in the qof is way off center, but still legit IMO."]},
    {'wlc-index': 27,
    ...
    'at issue': "הּ",
    'summary': "+mapiq",
    'remarks': ["The MPK has no letter to carry a mapiq for the qere’s ה. "+
    ...
    'summary': "+dgsh",
    'remarks': ["The MPK has no letter to carry a dagesh for the qere’s yod.",
        "Side note: The rafeh on the א makes it clear that the qere’s yod functions as a consonant not a vowel, i.e. the qere’s syllables are מִ־דָּֽ־נִ־יֵּ֑אל."]},
    {'wlc-index': 35,
