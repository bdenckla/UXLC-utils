...
_HUNDREDS = ('', _HLQOF)
_TENS = (
    '', _HLYOD, _HLKAF, _HLLAMED, _HLMEM,
    _HLNUN, _HLSAMEKH, _HLAYIN, _HLPE, _HLTSADE)
_ONES = (
    '', _HLALEF, _HLBET, _HLGIMEL, _HLDALET,
    _HLHE, _HLVAV, _HLZAYIN, _HLHET, _HLTET)
...
def _gen_table():
    hto_triples = tuple(itertools.product(_HUNDREDS, _TENS, _ONES))
