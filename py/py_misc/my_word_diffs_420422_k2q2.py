...
import py_misc.my_html_for_img as my_html_for_img
from py_misc.my_html_span_romanized import rmn
...
def _html_for_bcv_str_wlt_tdu(bcv_str):  # wlt_tdu: with link to tanach.us
    return my_html.anchor(bcv_str, {"href": f"https://tanach.us/Tanach.xml?{bcv_str}"})
...
def _intro_and_img(k2q2rec):
    return [
        my_html.para([*k2q2rec["intro"], " ", *_html_for_pcl(k2q2rec["pcl"])]),
...
_SND_SAM_5_2_VMG_ARCHIVE_DOT_ORG_ANC = my_html.anchor(
...
EZRA_4_12 = [
    ...
    my_html.table(
        [
            my_html.table_row_of_headers(["", "", "word boundary"]),
    ...
    *_intro_and_img(_BKM_REC_SND_SAM_5_2),
    ...
    my_html.para(["We can summarize this table as follows:"]),
    my_html.unordered_list(
        [
